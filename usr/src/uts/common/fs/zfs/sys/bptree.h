...
typedef void bptree_notification_t(void *arg, uint64_t slot);
...
uint64_t bptree_last_entry(objset_t *os, uint64_t obj);
...
int bptree_iterate(objset_t *os, uint64_t obj, boolean_t free,
    bptree_itor_t func, bptree_notification_t notify_func, void *arg,
    dmu_tx_t *tx);
