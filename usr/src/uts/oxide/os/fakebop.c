...
wait_for_psp(void)
{
	 ...
	 * - Gimlet + Milan (EPYC 7713P 64c) ~91000 ticks
	 * - Cosmo  + Turin (EPYC 9655P 96c) ~2800000000 ticks
	 * (Note at this point we're still running at the boot frequency)
	 */
